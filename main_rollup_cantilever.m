...
midNodes=setdiff(1:noNd,[leftNodes;rightNodes;botNodes;topNodes]);
...
Shear=-mat.h^3*4000*0;
I=b*mat.h^3/12;
R=l/(2*pi);
Moment=(mat.E*I/R)/b;                %Moment required to obtain 1 complete coil
q=[0;0;0];
